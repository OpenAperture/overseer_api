...
defmodule OpenAperture.OverseerApi do
  ...
  def start(_type, _args) do
    ...
    Logger.info("Starting OpenAperture.OverseerApi...")

    children = [
      # Define workers and child supervisors to be supervised
      worker(OpenAperture.OverseerApi.ModuleRegistration, []),
      worker(OpenAperture.OverseerApi.Publisher, []),
      worker(OpenAperture.OverseerApi.Heartbeat, [])
    ]

    opts = [strategy: :one_for_one, name: OpenAperture.OverseerApi.Supervisor]
